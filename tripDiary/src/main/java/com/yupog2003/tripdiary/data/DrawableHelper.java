...
public class DrawableHelper {
    ...
    public static Drawable getAccentTintDrawable(Context c, int drawableId) {
        return getTintDrawable(c, drawableId, ContextCompat.getColor(c, R.color.accent));
    }

    public static Drawable getTintDrawable(Context c, int drawableId, int color) {
