...
JNIEXPORT jboolean Java_com_yupog2003_tripdiary_data_GpxAnalyzer2_parse(JNIEnv* env, jobject thiz, jstring gpxPath, jobject cache, jint timezoneO) {
	stop = false;
...
JNIEXPORT bool Java_com_yupog2003_tripdiary_AllRecordActivity_parse(JNIEnv* env, jobject thiz, jstring gpxPath, jobject record) {
	stop = false;
